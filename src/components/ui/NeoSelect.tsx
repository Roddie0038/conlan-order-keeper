...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "neopill flex items-center justify-between [&>span]:line-clamp-1 text-foreground placeholder:text-muted-foreground",
      props.disabled && "text-muted-foreground opacity-100",
      className
    )}
    {...props}
  >
