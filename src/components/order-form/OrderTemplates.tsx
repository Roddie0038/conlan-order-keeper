...
export const OrderTemplates = ({
  ...
  return <div className="flex gap-4 items-center mb-6">
      <Button onClick={saveTemplate} variant="outline" className="flex items-center gap-2 text-xl font-semibold text-slate-950 bg-neutral-500 hover:bg-neutral-400">
