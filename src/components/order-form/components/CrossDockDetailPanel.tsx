...
export function CrossDockDetailPanel({ form }: CrossDockDetailPanelProps) {
  ...
  return (
    <div className="mt-6 p-5 bg-purple-50 dark:bg-purple-900/10 rounded-lg border border-purple-200 dark:border-purple-800/40">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>Transfer Work Order Number*</FormLabel>
              <FormControl>
                <Input 
                  placeholder="Enter work order number" 
                  {...field} 
                  className="border-gray-300 focus:border-purple-300 focus:ring-1 focus:ring-purple-200"
                />
              </FormControl>
              <FormMessage />
            </FormItem>
        ...
        <FormItem className="flex flex-col">
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center justify-center w-full">
              <label 
                htmlFor="fileUpload" 
                className="flex flex-col items-center justify-center w-full h-24 border-2 border-dashed rounded-lg cursor-pointer hover:border-purple-400 border-gray-300 bg-gray-50 dark:bg-gray-700 dark:border-gray-600"
              >
      ...
      <div className="mt-6 space-y-4">
        ...
        <Button
          type="button"
          variant="outline"
          onClick={handlePrintCrossDockForm}
