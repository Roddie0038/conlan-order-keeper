...
export function PendingOrdersHeader() {
  ...
  return <header className="bg-primary/90 text-primary-foreground py-6 mb-8 backdrop-blur-sm rounded-full">
      <div className="container flex justify-between items-center">
        <div className="flex items-center gap-4">
          <img alt="Conlan Tire Logo" className="h-16 object-contain rounded-full" src="/lovable-uploads/6b4acdf2-c115-438c-9b27-2fb818afa2ed.png" />
          <div>
