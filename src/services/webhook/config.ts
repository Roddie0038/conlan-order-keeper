...
export const WEBHOOK_URLS = {
  ...
  // MTO Orders - Updated to latest Web App version
  MTO_ORDERS: "https://script.google.com/macros/s/AKfycbwP6FanfvmNNRt1W0GKQAZnz7Uzq8JkXCymWBaS1rOKi_o3_gvY38dobiih4EC-OjlCw/exec",
  // Admin Orders
