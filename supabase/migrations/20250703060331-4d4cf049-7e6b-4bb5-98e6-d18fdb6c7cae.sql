-- Phase 1: Database Schema Enhancements for Advanced Messaging System
...
ON public.message_templates 
FOR INSERT 
WITH CHECK (created_by = auth.uid() AND created_by_email = auth.email());
...
INSERT INTO public.message_templates (title, content, category, is_system, created_by, created_by_email) VALUES
('Order Being Prepared', 'Your order is currently being prepared and will be ready soon.', 'status', true, gen_random_uuid(), 'system@conlantire.com'),
('Awaiting Inventory', 'We are currently awaiting inventory update for this order.', 'status', true, gen_random_uuid(), 'system@conlantire.com'),
('Please Upload Invoice', 'Could you please upload the invoice for this order?', 'request', true, gen_random_uuid(), 'system@conlantire.com'),
('Order Ready for Pickup', 'Your order is ready for pickup at the warehouse.', 'status', true, gen_random_uuid(), 'system@conlantire.com'),
('Need More Information', 'We need additional information to process this order.', 'request', true, gen_random_uuid(), 'system@conlantire.com'),
('Order Shipped', 'Your order has been shipped and is on its way.', 'status', true, gen_random_uuid(), 'system@conlantire.com');