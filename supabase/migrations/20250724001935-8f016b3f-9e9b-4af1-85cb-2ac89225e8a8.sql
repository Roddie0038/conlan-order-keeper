-- COMPREHENSIVE STORE NORMALIZATION MIGRATION (Both Platforms)
...
CREATE OR REPLACE VIEW public.store_normalization_verification AS
SELECT 
    'orders' as table_name,
    'store' as column_name,
    store as original_value,
...
SELECT 
    ...
    store_number as original_value,
